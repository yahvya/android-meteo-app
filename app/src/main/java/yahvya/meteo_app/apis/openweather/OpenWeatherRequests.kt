...
interface OpenWeatherRequests {
    @GET(value="forecast?current=temperature_2m,weather_code,wind_speed_10m&daily=weather_code,temperature_2m_max,temperature_2m_min,wind_speed_10m_max&models=meteofrance_seamless&forecast_days=3")
